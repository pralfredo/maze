 ...
 * Date: April 23, 2023
 * Purpose: It is a representation of a 2D grid of cells. Each cell in the grid can be either an obstacle or free. 
 * The Maze class provides methods to iterate through the cells, 
 * initialize and reset the maze, get the number of rows and columns in the maze, 
 * get a cell at a specified row and column, get the neighboring cells of a specified cell, and draw the maze. 
 */
...
public class Maze implements Iterable<Cell> {
    ...
    /**
     * The toString method for the Maze
     */
